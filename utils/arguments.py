...
Typical Usage:
  python3 scanman.py -iL /path/to/targetfile.txt -m -n -e --ipparse --smbparse
...
group2.add_argument('--database', dest='database', default='.scanman.db', metavar='' , help='Filepath for database file.')
